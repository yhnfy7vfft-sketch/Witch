...
{
    /* Local fix: stop the game's render loop before the app can be
     * backgrounded so no GPU work is submitted while backgrounded
     * (SDL_PollEvent sleeps while this flag is set). */
    SDL_SetBackgroundedFlag(true);
