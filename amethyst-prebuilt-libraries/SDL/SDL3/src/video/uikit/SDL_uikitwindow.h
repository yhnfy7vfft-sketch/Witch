...
// Local: set when the SDL window reuses the host app's UIWindow (launcher
// game mode). A host window must not be hidden, made key, or have its root
// view controller repurposed by SDL.
@property(nonatomic) BOOL hostWindow;
