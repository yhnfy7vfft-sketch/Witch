...
{
    // View hierarchy changes must run on the main thread; SDL may be driving
    // the video subsystem from a non-main thread when embedded in an existing
    // app.
    ...
    dispatch_sync(dispatch_get_main_queue(), ^{
        @autoreleasepool {
            ...
            view = (void *)CFBridgingRetain(metalview);
        }
    });
    return view;
}
