...
/* Local: true when this game view is embedded in the host app's surface
 * (hostWindow). In that mode the host owns all input (touch, keyboard,
 * mouse), so SDL must not register its own handlers. */
