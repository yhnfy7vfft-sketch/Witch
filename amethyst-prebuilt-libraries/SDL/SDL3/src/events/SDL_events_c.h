...
/* Local: pause the game's render loop while the app is not active (see
 * SDL_PollEvent); toggled from the SDL_OnApplication* lifecycle hooks. */
extern void SDL_SetBackgroundedFlag(bool backgrounded);
