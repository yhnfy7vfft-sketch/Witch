...
public final class Library {
    ...
    private static void checkHash(Class<?> context, Path libFile, String module, String libName) {
        // Configuration.DISABLE_HASH_CHECKS only exists in 3.3.6+/3.4.1 forks; its default
        // is !CHECKS everywhere, so inlining the default keeps this shim compatible with
        // the 3.3.3 Configuration (referencing the field would throw NoSuchFieldError).
        if (!CHECKS) {
            return;
        }
