...
public final class GLCapabilities {
    ...
    static final int ADDRESS_BUFFER_SIZE = 2235;
    ...
    GLCapabilities(FunctionProvider provider, Set<String> ext, boolean fc, IntFunction<PointerBuffer> bufferFactory) {
        ...
        glShadingRateEXT = caps.get(1731);
        glShadingRateCombinerOpsEXT = caps.get(1732);
        glFramebufferShadingRateEXT = caps.get(1733);
        glGetFragmentShadingRatesEXT = caps.get(1734);
        glBlitFramebufferEXT = caps.get(1735);
        glBlitFramebufferLayersEXT = caps.get(1736);
        glBlitFramebufferLayerEXT = caps.get(1737);
        glRenderbufferStorageMultisampleEXT = caps.get(1738);
        glIsRenderbufferEXT = caps.get(1739);
        glBindRenderbufferEXT = caps.get(1740);
        glDeleteRenderbuffersEXT = caps.get(1741);
        glGenRenderbuffersEXT = caps.get(1742);
        glRenderbufferStorageEXT = caps.get(1743);
        glGetRenderbufferParameterivEXT = caps.get(1744);
        glIsFramebufferEXT = caps.get(1745);
        glBindFramebufferEXT = caps.get(1746);
        glDeleteFramebuffersEXT = caps.get(1747);
        glGenFramebuffersEXT = caps.get(1748);
        glCheckFramebufferStatusEXT = caps.get(1749);
        glFramebufferTexture1DEXT = caps.get(1750);
        glFramebufferTexture2DEXT = caps.get(1751);
        glFramebufferTexture3DEXT = caps.get(1752);
        glFramebufferRenderbufferEXT = caps.get(1753);
        glGetFramebufferAttachmentParameterivEXT = caps.get(1754);
        glGenerateMipmapEXT = caps.get(1755);
        glProgramParameteriEXT = caps.get(1756);
        glFramebufferTextureEXT = caps.get(1757);
        glFramebufferTextureLayerEXT = caps.get(1758);
        glFramebufferTextureFaceEXT = caps.get(1759);
        glProgramEnvParameters4fvEXT = caps.get(1760);
        glProgramLocalParameters4fvEXT = caps.get(1761);
        glVertexAttribI1iEXT = caps.get(1762);
        glVertexAttribI2iEXT = caps.get(1763);
        glVertexAttribI3iEXT = caps.get(1764);
        glVertexAttribI4iEXT = caps.get(1765);
        glVertexAttribI1uiEXT = caps.get(1766);
        glVertexAttribI2uiEXT = caps.get(1767);
        glVertexAttribI3uiEXT = caps.get(1768);
        glVertexAttribI4uiEXT = caps.get(1769);
        glVertexAttribI1ivEXT = caps.get(1770);
        glVertexAttribI2ivEXT = caps.get(1771);
        glVertexAttribI3ivEXT = caps.get(1772);
        glVertexAttribI4ivEXT = caps.get(1773);
        glVertexAttribI1uivEXT = caps.get(1774);
        glVertexAttribI2uivEXT = caps.get(1775);
        glVertexAttribI3uivEXT = caps.get(1776);
        glVertexAttribI4uivEXT = caps.get(1777);
        glVertexAttribI4bvEXT = caps.get(1778);
        glVertexAttribI4svEXT = caps.get(1779);
        glVertexAttribI4ubvEXT = caps.get(1780);
        glVertexAttribI4usvEXT = caps.get(1781);
        glVertexAttribIPointerEXT = caps.get(1782);
        glGetVertexAttribIivEXT = caps.get(1783);
        glGetVertexAttribIuivEXT = caps.get(1784);
        glGetUniformuivEXT = caps.get(1785);
        glBindFragDataLocationEXT = caps.get(1786);
        glGetFragDataLocationEXT = caps.get(1787);
        glUniform1uiEXT = caps.get(1788);
        glUniform2uiEXT = caps.get(1789);
        glUniform3uiEXT = caps.get(1790);
        glUniform4uiEXT = caps.get(1791);
        glUniform1uivEXT = caps.get(1792);
        glUniform2uivEXT = caps.get(1793);
        glUniform3uivEXT = caps.get(1794);
        glUniform4uivEXT = caps.get(1795);
        glGetUnsignedBytevEXT = caps.get(1796);
        glGetUnsignedBytei_vEXT = caps.get(1797);
        glDeleteMemoryObjectsEXT = caps.get(1798);
        glIsMemoryObjectEXT = caps.get(1799);
        glCreateMemoryObjectsEXT = caps.get(1800);
        glMemoryObjectParameterivEXT = caps.get(1801);
        glGetMemoryObjectParameterivEXT = caps.get(1802);
        glTexStorageMem2DEXT = caps.get(1803);
        glTexStorageMem2DMultisampleEXT = caps.get(1804);
        glTexStorageMem3DEXT = caps.get(1805);
        glTexStorageMem3DMultisampleEXT = caps.get(1806);
        glBufferStorageMemEXT = caps.get(1807);
        glTextureStorageMem2DEXT = caps.get(1808);
        glTextureStorageMem2DMultisampleEXT = caps.get(1809);
        glTextureStorageMem3DEXT = caps.get(1810);
        glTextureStorageMem3DMultisampleEXT = caps.get(1811);
        glNamedBufferStorageMemEXT = caps.get(1812);
        glTexStorageMem1DEXT = caps.get(1813);
        glTextureStorageMem1DEXT = caps.get(1814);
        glImportMemoryFdEXT = caps.get(1815);
        glImportMemoryWin32HandleEXT = caps.get(1816);
        glImportMemoryWin32NameEXT = caps.get(1817);
        glDrawMeshTasksEXT = caps.get(1818);
        glDrawMeshTasksIndirectEXT = caps.get(1819);
        glMultiDrawMeshTasksIndirectEXT = caps.get(1820);
        glMultiDrawMeshTasksIndirectCountEXT = caps.get(1821);
        glPointParameterfEXT = caps.get(1822);
        glPointParameterfvEXT = caps.get(1823);
        glPolygonOffsetClampEXT = caps.get(1824);
        glProvokingVertexEXT = caps.get(1825);
        glRasterSamplesEXT = caps.get(1826);
        glSecondaryColor3bEXT = caps.get(1827);
        glSecondaryColor3sEXT = caps.get(1828);
        glSecondaryColor3iEXT = caps.get(1829);
        glSecondaryColor3fEXT = caps.get(1830);
        glSecondaryColor3dEXT = caps.get(1831);
        glSecondaryColor3ubEXT = caps.get(1832);
        glSecondaryColor3usEXT = caps.get(1833);
        glSecondaryColor3uiEXT = caps.get(1834);
        glSecondaryColor3bvEXT = caps.get(1835);
        glSecondaryColor3svEXT = caps.get(1836);
        glSecondaryColor3ivEXT = caps.get(1837);
        glSecondaryColor3fvEXT = caps.get(1838);
        glSecondaryColor3dvEXT = caps.get(1839);
        glSecondaryColor3ubvEXT = caps.get(1840);
        glSecondaryColor3usvEXT = caps.get(1841);
        glSecondaryColor3uivEXT = caps.get(1842);
        glSecondaryColorPointerEXT = caps.get(1843);
        glGenSemaphoresEXT = caps.get(1844);
        glDeleteSemaphoresEXT = caps.get(1845);
        glIsSemaphoreEXT = caps.get(1846);
        glSemaphoreParameterui64vEXT = caps.get(1847);
        glGetSemaphoreParameterui64vEXT = caps.get(1848);
        glWaitSemaphoreEXT = caps.get(1849);
        glSignalSemaphoreEXT = caps.get(1850);
        glImportSemaphoreFdEXT = caps.get(1851);
        glImportSemaphoreWin32HandleEXT = caps.get(1852);
        glImportSemaphoreWin32NameEXT = caps.get(1853);
        glUseShaderProgramEXT = caps.get(1854);
        glActiveProgramEXT = caps.get(1855);
        glCreateShaderProgramEXT = caps.get(1856);
        glFramebufferFetchBarrierEXT = caps.get(1857);
        glBindImageTextureEXT = caps.get(1858);
        glMemoryBarrierEXT = caps.get(1859);
        glStencilClearTagEXT = caps.get(1860);
        glActiveStencilFaceEXT = caps.get(1861);
        glTexBufferEXT = caps.get(1862);
        glClearColorIiEXT = caps.get(1863);
        glClearColorIuiEXT = caps.get(1864);
        glTexParameterIivEXT = caps.get(1865);
        glTexParameterIuivEXT = caps.get(1866);
        glGetTexParameterIivEXT = caps.get(1867);
        glGetTexParameterIuivEXT = caps.get(1868);
        glTexStorage1DEXT = caps.get(1869);
        glTexStorage2DEXT = caps.get(1870);
        glTexStorage3DEXT = caps.get(1871);
        glGetQueryObjecti64vEXT = caps.get(1872);
        glGetQueryObjectui64vEXT = caps.get(1873);
        glBindBufferRangeEXT = caps.get(1874);
        glBindBufferOffsetEXT = caps.get(1875);
        glBindBufferBaseEXT = caps.get(1876);
        glBeginTransformFeedbackEXT = caps.get(1877);
        glEndTransformFeedbackEXT = caps.get(1878);
        glTransformFeedbackVaryingsEXT = caps.get(1879);
        glGetTransformFeedbackVaryingEXT = caps.get(1880);
        glVertexAttribL1dEXT = caps.get(1881);
        glVertexAttribL2dEXT = caps.get(1882);
        glVertexAttribL3dEXT = caps.get(1883);
        glVertexAttribL4dEXT = caps.get(1884);
        glVertexAttribL1dvEXT = caps.get(1885);
        glVertexAttribL2dvEXT = caps.get(1886);
        glVertexAttribL3dvEXT = caps.get(1887);
        glVertexAttribL4dvEXT = caps.get(1888);
        glVertexAttribLPointerEXT = caps.get(1889);
        glGetVertexAttribLdvEXT = caps.get(1890);
        glAcquireKeyedMutexWin32EXT = caps.get(1891);
        glReleaseKeyedMutexWin32EXT = caps.get(1892);
        glWindowRectanglesEXT = caps.get(1893);
        glImportSyncEXT = caps.get(1894);
        glFrameTerminatorGREMEDY = caps.get(1895);
        glStringMarkerGREMEDY = caps.get(1896);
        glApplyFramebufferAttachmentCMAAINTEL = caps.get(1897);
        glSyncTextureINTEL = caps.get(1898);
        glUnmapTexture2DINTEL = caps.get(1899);
        glMapTexture2DINTEL = caps.get(1900);
        glBeginPerfQueryINTEL = caps.get(1901);
        glCreatePerfQueryINTEL = caps.get(1902);
        glDeletePerfQueryINTEL = caps.get(1903);
        glEndPerfQueryINTEL = caps.get(1904);
        glGetFirstPerfQueryIdINTEL = caps.get(1905);
        glGetNextPerfQueryIdINTEL = caps.get(1906);
        glGetPerfCounterInfoINTEL = caps.get(1907);
        glGetPerfQueryDataINTEL = caps.get(1908);
        glGetPerfQueryIdByNameINTEL = caps.get(1909);
        glGetPerfQueryInfoINTEL = caps.get(1910);
        glBlendBarrierKHR = caps.get(1911);
        glMaxShaderCompilerThreadsKHR = caps.get(1912);
        glFramebufferParameteriMESA = caps.get(1913);
        glGetFramebufferParameterivMESA = caps.get(1914);
        glAlphaToCoverageDitherControlNV = caps.get(1915);
        glMultiDrawArraysIndirectBindlessNV = caps.get(1916);
        glMultiDrawElementsIndirectBindlessNV = caps.get(1917);
        glMultiDrawArraysIndirectBindlessCountNV = caps.get(1918);
        glMultiDrawElementsIndirectBindlessCountNV = caps.get(1919);
        glGetTextureHandleNV = caps.get(1920);
        glGetTextureSamplerHandleNV = caps.get(1921);
        glMakeTextureHandleResidentNV = caps.get(1922);
        glMakeTextureHandleNonResidentNV = caps.get(1923);
        glGetImageHandleNV = caps.get(1924);
        glMakeImageHandleResidentNV = caps.get(1925);
        glMakeImageHandleNonResidentNV = caps.get(1926);
        glUniformHandleui64NV = caps.get(1927);
        glUniformHandleui64vNV = caps.get(1928);
        glProgramUniformHandleui64NV = caps.get(1929);
        glProgramUniformHandleui64vNV = caps.get(1930);
        glIsTextureHandleResidentNV = caps.get(1931);
        glIsImageHandleResidentNV = caps.get(1932);
        glBlendParameteriNV = caps.get(1933);
        glBlendBarrierNV = caps.get(1934);
        glViewportPositionWScaleNV = caps.get(1935);
        glCreateStatesNV = caps.get(1936);
        glDeleteStatesNV = caps.get(1937);
        glIsStateNV = caps.get(1938);
        glStateCaptureNV = caps.get(1939);
        glGetCommandHeaderNV = caps.get(1940);
        glGetStageIndexNV = caps.get(1941);
        glDrawCommandsNV = caps.get(1942);
        glDrawCommandsAddressNV = caps.get(1943);
        glDrawCommandsStatesNV = caps.get(1944);
        glDrawCommandsStatesAddressNV = caps.get(1945);
        glCreateCommandListsNV = caps.get(1946);
        glDeleteCommandListsNV = caps.get(1947);
        glIsCommandListNV = caps.get(1948);
        glListDrawCommandsStatesClientNV = caps.get(1949);
        glCommandListSegmentsNV = caps.get(1950);
        glCompileCommandListNV = caps.get(1951);
        glCallCommandListNV = caps.get(1952);
        glBeginConditionalRenderNV = caps.get(1953);
        glEndConditionalRenderNV = caps.get(1954);
        glSubpixelPrecisionBiasNV = caps.get(1955);
        glConservativeRasterParameterfNV = caps.get(1956);
        glConservativeRasterParameteriNV = caps.get(1957);
        glCopyImageSubDataNV = caps.get(1958);
        glDepthRangedNV = caps.get(1959);
        glClearDepthdNV = caps.get(1960);
        glDepthBoundsdNV = caps.get(1961);
        glDrawTextureNV = caps.get(1962);
        glDrawVkImageNV = caps.get(1963);
        glGetVkProcAddrNV = caps.get(1964);
        glWaitVkSemaphoreNV = caps.get(1965);
        glSignalVkSemaphoreNV = caps.get(1966);
        glSignalVkFenceNV = caps.get(1967);
        glGetMultisamplefvNV = caps.get(1968);
        glSampleMaskIndexedNV = caps.get(1969);
        glTexRenderbufferNV = caps.get(1970);
        glDeleteFencesNV = caps.get(1971);
        glGenFencesNV = caps.get(1972);
        glIsFenceNV = caps.get(1973);
        glTestFenceNV = caps.get(1974);
        glGetFenceivNV = caps.get(1975);
        glFinishFenceNV = caps.get(1976);
        glSetFenceNV = caps.get(1977);
        glFragmentCoverageColorNV = caps.get(1978);
        glCoverageModulationTableNV = caps.get(1979);
        glGetCoverageModulationTableNV = caps.get(1980);
        glCoverageModulationNV = caps.get(1981);
        glRenderbufferStorageMultisampleCoverageNV = caps.get(1982);
        glRenderGpuMaskNV = caps.get(1983);
        glMulticastBufferSubDataNV = caps.get(1984);
        glMulticastCopyBufferSubDataNV = caps.get(1985);
        glMulticastCopyImageSubDataNV = caps.get(1986);
        glMulticastBlitFramebufferNV = caps.get(1987);
        glMulticastFramebufferSampleLocationsfvNV = caps.get(1988);
        glMulticastBarrierNV = caps.get(1989);
        glMulticastWaitSyncNV = caps.get(1990);
        glMulticastGetQueryObjectivNV = caps.get(1991);
        glMulticastGetQueryObjectuivNV = caps.get(1992);
        glMulticastGetQueryObjecti64vNV = caps.get(1993);
        glMulticastGetQueryObjectui64vNV = caps.get(1994);
        glVertex2hNV = caps.get(1995);
        glVertex2hvNV = caps.get(1996);
        glVertex3hNV = caps.get(1997);
        glVertex3hvNV = caps.get(1998);
        glVertex4hNV = caps.get(1999);
        glVertex4hvNV = caps.get(2000);
        glNormal3hNV = caps.get(2001);
        glNormal3hvNV = caps.get(2002);
        glColor3hNV = caps.get(2003);
        glColor3hvNV = caps.get(2004);
        glColor4hNV = caps.get(2005);
        glColor4hvNV = caps.get(2006);
        glTexCoord1hNV = caps.get(2007);
        glTexCoord1hvNV = caps.get(2008);
        glTexCoord2hNV = caps.get(2009);
        glTexCoord2hvNV = caps.get(2010);
        glTexCoord3hNV = caps.get(2011);
        glTexCoord3hvNV = caps.get(2012);
        glTexCoord4hNV = caps.get(2013);
        glTexCoord4hvNV = caps.get(2014);
        glMultiTexCoord1hNV = caps.get(2015);
        glMultiTexCoord1hvNV = caps.get(2016);
        glMultiTexCoord2hNV = caps.get(2017);
        glMultiTexCoord2hvNV = caps.get(2018);
        glMultiTexCoord3hNV = caps.get(2019);
        glMultiTexCoord3hvNV = caps.get(2020);
        glMultiTexCoord4hNV = caps.get(2021);
        glMultiTexCoord4hvNV = caps.get(2022);
        glFogCoordhNV = caps.get(2023);
        glFogCoordhvNV = caps.get(2024);
        glSecondaryColor3hNV = caps.get(2025);
        glSecondaryColor3hvNV = caps.get(2026);
        glVertexWeighthNV = caps.get(2027);
        glVertexWeighthvNV = caps.get(2028);
        glVertexAttrib1hNV = caps.get(2029);
        glVertexAttrib1hvNV = caps.get(2030);
        glVertexAttrib2hNV = caps.get(2031);
        glVertexAttrib2hvNV = caps.get(2032);
        glVertexAttrib3hNV = caps.get(2033);
        glVertexAttrib3hvNV = caps.get(2034);
        glVertexAttrib4hNV = caps.get(2035);
        glVertexAttrib4hvNV = caps.get(2036);
        glVertexAttribs1hvNV = caps.get(2037);
        glVertexAttribs2hvNV = caps.get(2038);
        glVertexAttribs3hvNV = caps.get(2039);
        glVertexAttribs4hvNV = caps.get(2040);
        glGetInternalformatSampleivNV = caps.get(2041);
        glGetMemoryObjectDetachedResourcesuivNV = caps.get(2042);
        glResetMemoryObjectParameterNV = caps.get(2043);
        glTexAttachMemoryNV = caps.get(2044);
        glBufferAttachMemoryNV = caps.get(2045);
        glTextureAttachMemoryNV = caps.get(2046);
        glNamedBufferAttachMemoryNV = caps.get(2047);
        glBufferPageCommitmentMemNV = caps.get(2048);
        glNamedBufferPageCommitmentMemNV = caps.get(2049);
        glTexPageCommitmentMemNV = caps.get(2050);
        glTexturePageCommitmentMemNV = caps.get(2051);
        glDrawMeshTasksNV = caps.get(2052);
        glDrawMeshTasksIndirectNV = caps.get(2053);
        glMultiDrawMeshTasksIndirectNV = caps.get(2054);
        glMultiDrawMeshTasksIndirectCountNV = caps.get(2055);
        glPathCommandsNV = caps.get(2056);
        glPathCoordsNV = caps.get(2057);
        glPathSubCommandsNV = caps.get(2058);
        glPathSubCoordsNV = caps.get(2059);
        glPathStringNV = caps.get(2060);
        glPathGlyphsNV = caps.get(2061);
        glPathGlyphRangeNV = caps.get(2062);
        glPathGlyphIndexArrayNV = caps.get(2063);
        glPathMemoryGlyphIndexArrayNV = caps.get(2064);
        glCopyPathNV = caps.get(2065);
        glWeightPathsNV = caps.get(2066);
        glInterpolatePathsNV = caps.get(2067);
        glTransformPathNV = caps.get(2068);
        glPathParameterivNV = caps.get(2069);
        glPathParameteriNV = caps.get(2070);
        glPathParameterfvNV = caps.get(2071);
        glPathParameterfNV = caps.get(2072);
        glPathDashArrayNV = caps.get(2073);
        glGenPathsNV = caps.get(2074);
        glDeletePathsNV = caps.get(2075);
        glIsPathNV = caps.get(2076);
        glPathStencilFuncNV = caps.get(2077);
        glPathStencilDepthOffsetNV = caps.get(2078);
        glStencilFillPathNV = caps.get(2079);
        glStencilStrokePathNV = caps.get(2080);
        glStencilFillPathInstancedNV = caps.get(2081);
        glStencilStrokePathInstancedNV = caps.get(2082);
        glPathCoverDepthFuncNV = caps.get(2083);
        glPathColorGenNV = caps.get(2084);
        glPathTexGenNV = caps.get(2085);
        glPathFogGenNV = caps.get(2086);
        glCoverFillPathNV = caps.get(2087);
        glCoverStrokePathNV = caps.get(2088);
        glCoverFillPathInstancedNV = caps.get(2089);
        glCoverStrokePathInstancedNV = caps.get(2090);
        glStencilThenCoverFillPathNV = caps.get(2091);
        glStencilThenCoverStrokePathNV = caps.get(2092);
        glStencilThenCoverFillPathInstancedNV = caps.get(2093);
        glStencilThenCoverStrokePathInstancedNV = caps.get(2094);
        glPathGlyphIndexRangeNV = caps.get(2095);
        glProgramPathFragmentInputGenNV = caps.get(2096);
        glGetPathParameterivNV = caps.get(2097);
        glGetPathParameterfvNV = caps.get(2098);
        glGetPathCommandsNV = caps.get(2099);
        glGetPathCoordsNV = caps.get(2100);
        glGetPathDashArrayNV = caps.get(2101);
        glGetPathMetricsNV = caps.get(2102);
        glGetPathMetricRangeNV = caps.get(2103);
        glGetPathSpacingNV = caps.get(2104);
        glGetPathColorGenivNV = caps.get(2105);
        glGetPathColorGenfvNV = caps.get(2106);
        glGetPathTexGenivNV = caps.get(2107);
        glGetPathTexGenfvNV = caps.get(2108);
        glIsPointInFillPathNV = caps.get(2109);
        glIsPointInStrokePathNV = caps.get(2110);
        glGetPathLengthNV = caps.get(2111);
        glPointAlongPathNV = caps.get(2112);
        glMatrixLoad3x2fNV = caps.get(2113);
        glMatrixLoad3x3fNV = caps.get(2114);
        glMatrixLoadTranspose3x3fNV = caps.get(2115);
        glMatrixMult3x2fNV = caps.get(2116);
        glMatrixMult3x3fNV = caps.get(2117);
        glMatrixMultTranspose3x3fNV = caps.get(2118);
        glGetProgramResourcefvNV = caps.get(2119);
        glPixelDataRangeNV = caps.get(2120);
        glFlushPixelDataRangeNV = caps.get(2121);
        glPointParameteriNV = caps.get(2122);
        glPointParameterivNV = caps.get(2123);
        glPrimitiveRestartNV = caps.get(2124);
        glPrimitiveRestartIndexNV = caps.get(2125);
        glQueryResourceNV = caps.get(2126);
        glGenQueryResourceTagNV = caps.get(2127);
        glDeleteQueryResourceTagNV = caps.get(2128);
        glQueryResourceTagNV = caps.get(2129);
        glFramebufferSampleLocationsfvNV = caps.get(2130);
        glNamedFramebufferSampleLocationsfvNV = caps.get(2131);
        glResolveDepthValuesNV = caps.get(2132);
        glScissorExclusiveArrayvNV = caps.get(2133);
        glScissorExclusiveNV = caps.get(2134);
        glMakeBufferResidentNV = caps.get(2135);
        glMakeBufferNonResidentNV = caps.get(2136);
        glIsBufferResidentNV = caps.get(2137);
        glMakeNamedBufferResidentNV = caps.get(2138);
        glMakeNamedBufferNonResidentNV = caps.get(2139);
        glIsNamedBufferResidentNV = caps.get(2140);
        glGetBufferParameterui64vNV = caps.get(2141);
        glGetNamedBufferParameterui64vNV = caps.get(2142);
        glGetIntegerui64vNV = caps.get(2143);
        glUniformui64NV = caps.get(2144);
        glUniformui64vNV = caps.get(2145);
        glProgramUniformui64NV = caps.get(2146);
        glProgramUniformui64vNV = caps.get(2147);
        glBindShadingRateImageNV = caps.get(2148);
        glShadingRateImagePaletteNV = caps.get(2149);
        glGetShadingRateImagePaletteNV = caps.get(2150);
        glShadingRateImageBarrierNV = caps.get(2151);
        glShadingRateSampleOrderNV = caps.get(2152);
        glShadingRateSampleOrderCustomNV = caps.get(2153);
        glGetShadingRateSampleLocationivNV = caps.get(2154);
        glTextureBarrierNV = caps.get(2155);
        glTexImage2DMultisampleCoverageNV = caps.get(2156);
        glTexImage3DMultisampleCoverageNV = caps.get(2157);
        glTextureImage2DMultisampleNV = caps.get(2158);
        glTextureImage3DMultisampleNV = caps.get(2159);
        glTextureImage2DMultisampleCoverageNV = caps.get(2160);
        glTextureImage3DMultisampleCoverageNV = caps.get(2161);
        glCreateSemaphoresNV = caps.get(2162);
        glSemaphoreParameterivNV = caps.get(2163);
        glGetSemaphoreParameterivNV = caps.get(2164);
        glBeginTransformFeedbackNV = caps.get(2165);
        glEndTransformFeedbackNV = caps.get(2166);
        glTransformFeedbackAttribsNV = caps.get(2167);
        glBindBufferRangeNV = caps.get(2168);
        glBindBufferOffsetNV = caps.get(2169);
        glBindBufferBaseNV = caps.get(2170);
        glTransformFeedbackVaryingsNV = caps.get(2171);
        glActiveVaryingNV = caps.get(2172);
        glGetVaryingLocationNV = caps.get(2173);
        glGetActiveVaryingNV = caps.get(2174);
        glGetTransformFeedbackVaryingNV = caps.get(2175);
        glTransformFeedbackStreamAttribsNV = caps.get(2176);
        glBindTransformFeedbackNV = caps.get(2177);
        glDeleteTransformFeedbacksNV = caps.get(2178);
        glGenTransformFeedbacksNV = caps.get(2179);
        glIsTransformFeedbackNV = caps.get(2180);
        glPauseTransformFeedbackNV = caps.get(2181);
        glResumeTransformFeedbackNV = caps.get(2182);
        glDrawTransformFeedbackNV = caps.get(2183);
        glVertexArrayRangeNV = caps.get(2184);
        glFlushVertexArrayRangeNV = caps.get(2185);
        glVertexAttribL1i64NV = caps.get(2186);
        glVertexAttribL2i64NV = caps.get(2187);
        glVertexAttribL3i64NV = caps.get(2188);
        glVertexAttribL4i64NV = caps.get(2189);
        glVertexAttribL1i64vNV = caps.get(2190);
        glVertexAttribL2i64vNV = caps.get(2191);
        glVertexAttribL3i64vNV = caps.get(2192);
        glVertexAttribL4i64vNV = caps.get(2193);
        glVertexAttribL1ui64NV = caps.get(2194);
        glVertexAttribL2ui64NV = caps.get(2195);
        glVertexAttribL3ui64NV = caps.get(2196);
        glVertexAttribL4ui64NV = caps.get(2197);
        glVertexAttribL1ui64vNV = caps.get(2198);
        glVertexAttribL2ui64vNV = caps.get(2199);
        glVertexAttribL3ui64vNV = caps.get(2200);
        glVertexAttribL4ui64vNV = caps.get(2201);
        glGetVertexAttribLi64vNV = caps.get(2202);
        glGetVertexAttribLui64vNV = caps.get(2203);
        glVertexAttribLFormatNV = caps.get(2204);
        glBufferAddressRangeNV = caps.get(2205);
        glVertexFormatNV = caps.get(2206);
        glNormalFormatNV = caps.get(2207);
        glColorFormatNV = caps.get(2208);
        glIndexFormatNV = caps.get(2209);
        glTexCoordFormatNV = caps.get(2210);
        glEdgeFlagFormatNV = caps.get(2211);
        glSecondaryColorFormatNV = caps.get(2212);
        glFogCoordFormatNV = caps.get(2213);
        glVertexAttribFormatNV = caps.get(2214);
        glVertexAttribIFormatNV = caps.get(2215);
        glGetIntegerui64i_vNV = caps.get(2216);
        glViewportSwizzleNV = caps.get(2217);
        glBeginConditionalRenderNVX = caps.get(2218);
        glEndConditionalRenderNVX = caps.get(2219);
        glAsyncCopyImageSubDataNVX = caps.get(2220);
        glAsyncCopyBufferSubDataNVX = caps.get(2221);
        glUploadGpuMaskNVX = caps.get(2222);
        glMulticastViewportArrayvNVX = caps.get(2223);
        glMulticastScissorArrayvNVX = caps.get(2224);
        glMulticastViewportPositionWScaleNVX = caps.get(2225);
        glCreateProgressFenceNVX = caps.get(2226);
        glSignalSemaphoreui64NVX = caps.get(2227);
        glWaitSemaphoreui64NVX = caps.get(2228);
        glClientWaitSemaphoreui64NVX = caps.get(2229);
        glFramebufferTextureMultiviewOVR = caps.get(2230);
        glNamedFramebufferTextureMultiviewOVR = caps.get(2231);
    ...
    private static boolean check_EXT_memory_object(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            1796, 1797, 1798, 1799, 1800, 1801, 1802, 1803, 1804, 1805, 1806, 1807, flag0 + 1808, flag0 + 1809, flag0 + 1810, flag0 + 1811, flag0 + 1812, 1813, 
            flag0 + 1814
        },
    ...
    private static boolean check_EXT_semaphore(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            1796, 1797, 1844, 1845, 1846, 1847, 1848, 1849, 1850
        },
    ...
    private static boolean check_EXT_texture_storage(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            1869, 1870, 1871, flag0 + 1374, flag0 + 1375, flag0 + 1376
        },
    ...
    private static boolean check_EXT_transform_feedback(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            1874, 1875, 1876, 1877, 1878, 1879, 1880, 1594, 1595
        },
    ...
    private static boolean check_EXT_vertex_attrib_64bit(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            1881, 1882, 1883, 1884, 1885, 1886, 1887, 1888, 1889, 1890, flag0 + 1383
        },
    ...
    private static boolean check_NV_half_float(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            ...
            2019, 2020, 2021, 2022, flag0 + 2023, flag0 + 2024, flag2 + 2025, flag2 + 2026, flag4 + 2027, flag4 + 2028, flag6 + 2029, flag6 + 2030, 
            flag6 + 2031, flag6 + 2032, flag6 + 2033, flag6 + 2034, flag6 + 2035, flag6 + 2036, flag6 + 2037, flag6 + 2038, flag6 + 2039, flag6 + 2040
        },
    ...
    private static boolean check_NV_memory_attachment(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2042, 2043, 2044, 2045, flag0 + 2046, flag0 + 2047
        },
    ...
    private static boolean check_NV_path_rendering(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2056, 2057, 2058, 2059, 2060, 2061, 2062, 2065, 2067, 2068, 2069, 2070, 2071, 2072, 2073, 2074, 2075, 2076, 2077, 2078, 2079, 2080, 2081, 2082, 
            2083, 2087, 2088, 2089, 2090, 2097, 2098, 2099, 2100, 2101, 2102, 2103, 2104, 2109, 2110, 2111, 2112
        },
    ...
    private static boolean check_NV_shader_buffer_load(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2135, 2136, 2137, 2138, 2139, 2140, 2141, 2142, 2143, 2144, 2145, 1075, 2146, 2147
        },
    ...
    private static boolean check_NV_vertex_attrib_integer_64bit(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2186, 2187, 2188, 2189, 2190, 2191, 2192, 2193, 2194, 2195, 2196, 2197, 2198, 2199, 2200, 2201, 2202, 2203, flag0 + 2204
        },
